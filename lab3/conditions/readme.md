Есть функция, которая занимается поиском по файлу. Но делает она это не очень быстро и необходимо её оптимизировать.
...
! Параллелить (использовать горутины) или sync.Pool в этом задании не нужно.
